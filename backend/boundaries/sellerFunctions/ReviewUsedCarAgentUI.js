import ReviewUsedCarAgentController from "../../controllers/sellerFunctions/ReviewUsedCarAgentController.js";
...
var reviewUI = new ReviewUsedCarAgentUI();
document.getElementById("submit").addEventListener("click", () => {
    reviewUI.onSubmit();
});
window.onload = reviewUI.displayPage();